...
def execute(filters=None):
    ...
    if filters:
        if filters.get("status") == "Pending":
            conditions.append("otorf.inc_20_status = 'Pending'")
        elif filters.get("status") == "Completed Before Due Date":
            conditions.append("otorf.inc_20_status = 'Completed' AND otorf.inc_20_submitted_on <= otorf.inc_20_due_date")
    ...
    if conditions:
        sql_query = f"""
            SELECT
                ...
                otorf.inc_20_due_date AS due_date,
