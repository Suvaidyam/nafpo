...
frappe.ui.form.on("FPO Profiling", {
    async refresh(frm) {
        ...
        await extend_options_length(frm, ['fpo_name', 'fpo_name', 'district_name', 'name_of_the_fpo', 'bod_kyc_name', 'name_of_cbbo'])
        ...
        await apply_filter('name_of_the_fpo', 'block', frm, frm.doc.block_name)
